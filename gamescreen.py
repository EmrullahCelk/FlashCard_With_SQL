...
"}")
        ...
        self.widget.setGeometry(QtCore.QRect(9, 9, 881, 581))
        ...
        self.game_time_txt = QtWidgets.QLabel(self.widget)
        ...
        self.game_timer = QtWidgets.QSpinBox(self.widget)
        self.game_timer.setMinimumSize(QtCore.QSize(50, 30))
        self.game_timer.setStyleSheet("\n"
"background-color: qradialgradient(spread:repeat, cx:0.5, cy:0.5, radius:0.968, fx:0.5, fy:0.5, stop:0 rgba(255, 188, 85, 255), stop:1 rgba(255, 255, 255, 255));\n"
"\n")
        font = QtGui.QFont()
        font.setPointSize(13)
        self.game_timer.setFont(font)
        self.game_timer.setWrapping(False)
        self.game_timer.setAlignment(QtCore.Qt.AlignCenter)
        self.game_timer.setReadOnly(False)
        self.game_timer.setSpecialValueText("")
        self.game_timer.setKeyboardTracking(True)
        self.game_timer.setPrefix("")
        self.game_timer.setMinimum(1)
        self.game_timer.setMaximum(10)
        self.game_timer.setSingleStep(1)
        self.game_timer.setProperty("value", 5)
        self.game_timer.setObjectName("game_timer")
        self.horizontalLayout.addWidget(self.game_timer)
...
"}")
        ...
        self.game_btn_custom = QtWidgets.QPushButton(self.verticalFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.game_btn_custom.sizePolicy().hasHeightForWidth())
        self.game_btn_custom.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.game_btn_custom.setFont(font)
        self.game_btn_custom.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.game_btn_custom.setStyleSheet("border:none\n"
"")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/addbutton.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.game_btn_custom.setIcon(icon1)
        self.game_btn_custom.setIconSize(QtCore.QSize(32, 32))
        self.game_btn_custom.setObjectName("game_btn_custom")
        self.horizontalLayout_7.addWidget(self.game_btn_custom)
        ...
        self.game_progres_bar = QtWidgets.QProgressBar(self.widget)
        ...
        self.game_txt_skor = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        ...
        self.game_btn_no = QtWidgets.QPushButton(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/cross1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.game_btn_no.setIcon(icon2)
        ...
        self.game_btn_yes = QtWidgets.QPushButton(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/check2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.game_btn_yes.setIcon(icon3)
        ...
        self.game_btn_back = QtWidgets.QPushButton(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"")
        ...
        self.game_btn_back.setIcon(icon4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action3.setText(_translate("MainWindow", "1"))
        self.action4.setText(_translate("MainWindow", "4"))
        self.action5.setText(_translate("MainWindow", "3"))
        self.action7.setText(_translate("MainWindow", "5"))
